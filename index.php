...
<body>
    ...
    <div class="How">
	  <div class="container">
        <div class="Howto">
                <a name="join" class="font-weight-bold">How to become a Member</a>
                <br />          
        </div>
				...
				<br/><br/> <br/><br/><br/> <br/><br/>
				 ...
				 <div class="col-sm-6">
				  ...
				  <!-- Facebook -->
                    ...
                    <!-- Twitter -->
                    <a type="button" href="https://twitter.com/wayfinders_busi" class="btn-floating btn-tw mx-3">
